...
namespace oomph
{
  ...
  //=================================================================
  //FOR PYOOMPH: Adde the flag skip_init_calls
  QuadTreeForest::QuadTreeForest(Vector<TreeRoot*>& trees_pt,bool skip_init_calls)
    : TreeForest(trees_pt)
  {
#ifdef LEAK_CHECK
    ...
    if (skip_init_calls) return; // FOR PYOOMPH: Skip these calls if desired
